...
ServoConfig Config::getServoConfig()
{
	...
	config.max_upper_eyelid = (uint8_t)(this->prefs.getUShort("max_upper_eyelid", 150));
	config.mid_upper_eyelid = (uint8_t)(this->prefs.getUShort("mid_upper_eyelid", 85));
	config.min_upper_eyelid = (uint8_t)(this->prefs.getUShort("min_upper_eyelid", 50));
	config.max_lower_eyelid = (uint8_t)(this->prefs.getUShort("max_lower_eyelid", 65));
	config.mid_lower_eyelid = (uint8_t)(this->prefs.getUShort("mid_lower_eyelid", 50));
	config.min_lower_eyelid = (uint8_t)(this->prefs.getUShort("min_lower_eyelid", 22));
...
void Config::setServoConfig(const ServoConfig &config)
{
	...
	this->prefs.putUShort("max_upper_eyelid", (uint16_t)(config.max_upper_eyelid));
	this->prefs.putUShort("mid_upper_eyelid", (uint16_t)(config.mid_upper_eyelid));
	this->prefs.putUShort("min_upper_eyelid", (uint16_t)(config.min_upper_eyelid));
	this->prefs.putUShort("max_lower_eyelid", (uint16_t)(config.max_lower_eyelid));
	this->prefs.putUShort("mid_lower_eyelid", (uint16_t)(config.mid_lower_eyelid));
	this->prefs.putUShort("min_lower_eyelid", (uint16_t)(config.min_lower_eyelid));
